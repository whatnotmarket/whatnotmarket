...
const TrendingRequests = dynamic(
  () => import("@/components/features/market/TrendingRequests").then((mod) => mod.TrendingRequests),
  {
...
const CategoryExplore = dynamic(
  () => import("@/components/features/market/CategoryExplore").then((mod) => mod.CategoryExplore),
  {
...
const HowItWorks = dynamic(
  () => import("@/components/features/market/HowItWorks").then((mod) => mod.HowItWorks),
  {
...
const TopSellersSection = dynamic(
  () => import("@/components/features/market/TopSellersSection").then((mod) => mod.TopSellersSection),
  {
