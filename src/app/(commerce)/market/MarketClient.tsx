...
const TrendingRequests = dynamic(() => import("@/components/features/market/TrendingRequests").then(mod => mod.TrendingRequests), {
  loading: () => <div className="h-[500px] animate-pulse bg-white/5 rounded-[40px]" />,
  ssr: true
});

const CategoryExplore = dynamic(() => import("@/components/features/market/CategoryExplore").then(mod => mod.CategoryExplore), {
  loading: () => <div className="h-32 animate-pulse bg-white/5 rounded-[30px]" />,
  ssr: true
});

const HowItWorks = dynamic(() => import("@/components/features/market/HowItWorks").then(mod => mod.HowItWorks), {
  loading: () => <div className="h-64 animate-pulse bg-white/5 rounded-[30px]" />,
  ssr: true
});

const TrustCTA = dynamic(() => import("@/components/features/market/TrustCTA").then(mod => mod.TrustCTA), {
  loading: () => <div className="h-48 animate-pulse bg-white/5 rounded-[30px]" />,
  ssr: true
});

const TopSellersSection = dynamic(() => import("@/components/features/market/TopSellersSection").then(mod => mod.TopSellersSection), {
                  ...
                  >
                    <div className="relative z-10 space-y-4 max-w-2xl text-left">
                      ...
                      <p className="text-zinc-400 text-base md:text-lg leading-relaxed max-w-xl line-clamp-2">
                        {buyAnywhereCopy.desc || "Find something outside the marketplace? Paste any product link and we'll purchase it for you using crypto â€” privately and securely."}
                      </p>
                    </div>
