...
I request verification to become an Escrow Partner.`;
  ...
  const handleOpenTelegram = () => {
    window.open("https://t.me/openlymarketbot?start=become-escrow", "_blank");
  };
                  ...
                  >
                    ...
                    <section className="space-y-4">
                      ...
                      <p className="text-zinc-400 leading-relaxed">
                        OpenlyMarket allows experienced and trusted individuals to become Escrow Partners on the platform.
