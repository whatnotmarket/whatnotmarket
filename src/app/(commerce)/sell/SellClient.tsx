...
export function SellClient({ copy }: { copy: CopyMap }) {
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col">
              ...
              <div className="p-8 md:p-10 space-y-10">
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    <div className="space-y-2 relative">
                      <label className="text-sm font-medium text-zinc-300">{form.title_label || "What are you selling?"}</label>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-[#2C2C2E] p-4 rounded-2xl border border-white/5">
                    <div className="flex flex-col">
                      <span className="text-sm font-medium text-white">{form.price_label || "Selling Price"}</span>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <SearchableSelect
                        label={form.payment_label || "Accepted Crypto"}
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-2">
                    <label className="text-sm font-medium text-zinc-300">{form.desc_label || "Description"}</label>
                    <textarea 
              ...
              <div className="sticky bottom-0 z-20 bg-[#1C1C1E]/95 backdrop-blur-md border-t border-white/5 p-6 md:px-10 flex items-center justify-between">
                ...
                >
                  {loading ? <Loader2 className="h-5 w-5 animate-spin" /> : (form.submit_button || "List Item")}
                </Button>
              </div>
