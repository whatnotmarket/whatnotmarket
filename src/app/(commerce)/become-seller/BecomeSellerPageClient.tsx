                  ...
                  >
                    ...
                    <section className="space-y-4">
                      ...
                      <p className="text-zinc-400 leading-relaxed">
                        ...
                        Il nostro sistema ÃƒÂ¨ progettato per essere <strong>privacy-first</strong>: non richiediamo KYC obbligatorio. Invece, utilizziamo un modello basato su reputazione, storico delle vendite e responsabilitÃƒÂ  economica.
                      </p>
                    </section>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
                      <section className="space-y-4 h-full">
                        ...
                        <p className="text-sm text-zinc-400">
                          ÃƒË† richiesta una quota di ingresso <strong>non rimborsabile</strong> di <span className="text-white font-bold">$20</span>. Questa quota serve a:
                        </p>
                    ...
                    <section className="space-y-6">
                      <div className="bg-[#0A0A0A] border border-white/5 rounded-2xl p-6">
                        ...
                        <p className="text-zinc-300 mb-6 font-medium">
                          Per alcune categorie o venditori ad alto volume, ÃƒÂ¨ richiesto un deposito di sicurezza (Vendor Bond).
                            ...
                            <div className="space-y-4 flex-1 flex flex-col">
                              <div className="bg-[#1C1C1E] p-4 rounded-lg border border-white/5 flex-1">
                                ...
                                <p className="text-xs text-zinc-400 leading-relaxed">
                                  Per attivare l'account venditore, ÃƒÂ¨ necessario bloccare un importo minimo in criptovalute (USDT, BTC, XMR). Questo fondo rimane tuo ma viene bloccato come garanzia.
                                  <br />
                          ...
                          <div className="space-y-3 h-full flex flex-col">
                            ...
                            <div className="space-y-4 flex-1 flex flex-col">
                              <div className="bg-[#1C1C1E] p-4 rounded-lg border border-white/5 flex-1">
                                ...
                                <p className="text-xs text-zinc-400 leading-relaxed">
                                  Il valore totale dei tuoi ordini attivi non puÃƒÂ² superare un multiplo del tuo bond. Se raggiungi il limite, devi aumentare il bond o completare gli ordini esistenti.
                                  <br />
                                  <span className="text-zinc-500 font-medium mt-2 block">Formula: Max Ordini = Bond Ãƒâ€” 3</span>
                                </p>
                              </div>
                              <div className="bg-[#1C1C1E] p-4 rounded-lg border border-white/5 flex-1">
                                <div className="text-sm font-bold text-white mb-2">4. Confisca</div>
                                <p className="text-xs text-zinc-400 leading-relaxed">
                                  In caso di comportamenti scorretti, il bond puÃƒÂ² essere confiscato per rimborsare gli acquirenti danneggiati.
                        ...
                        <div className="mt-6 pt-4 border-t border-white/5 text-xs text-zinc-500 font-medium">
                          *Venditori con ottima reputazione (100+ vendite, 98% feedback) possono ottenere riduzioni del bond richiesto.
                          Il ritiro del bond ÃƒÂ¨ possibile solo senza ordini attivi e dopo un periodo di sicurezza.
                        </div>
                      </div>
                    </section>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
                       <section className="space-y-4 h-full flex flex-col">
                        ...
                        <div className="flex flex-wrap gap-2">
                            {["Vendite completate", "Feedback positivi", "Volume transazioni", "VelocitÃƒÂ  risposta", "Dispute vinte"].map((item) => (
                        ...
                        <p className="text-xs text-zinc-500 mt-auto pt-2 font-medium">
                            PiÃƒÂ¹ alto ÃƒÂ¨ il punteggio, maggiore sarÃƒÂ  la visibilitÃƒÂ .
                        </p>
                      </section>
                      ...
                      <section className="space-y-4 h-full flex flex-col">
                        ...
                        <p className="text-xs text-zinc-500 mt-auto pt-2 font-medium">
                            Livelli alti = Commissioni piÃƒÂ¹ basse e prioritÃƒÂ .
                        </p>
                      </section>
                    </div>
                    ...
                    <section className="text-center space-y-8 pt-4">
                      <div className="max-w-2xl mx-auto space-y-4">
                        ...
                        <p className="text-zinc-400">
                            Il nostro obiettivo ÃƒÂ¨ creare un ambiente sicuro senza compromettere la privacy.
