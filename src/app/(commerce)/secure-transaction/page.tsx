              ...
              <div className="p-8 md:p-10 space-y-12">
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-zinc-400 leading-relaxed">
                    Su OpenlyMarket ogni transazione ÃƒÂ¨ protetta tramite un sistema di escrow sicuro progettato per proteggere sia gli acquirenti che i venditori.
                ...
                <section className="space-y-6">
                  <h3 className="text-xl font-bold text-white font-inter">Come funziona lÃ¢â‚¬â„¢Escrow</h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="bg-[#0A0A0A] p-6 rounded-2xl border border-white/5 space-y-4 relative overflow-hidden group hover:border-white/20 transition-colors">
                      ...
                      <h4 className="text-white font-bold text-lg">Creazione dellÃ¢â‚¬â„¢accordo</h4>
                    ...
                    <div className="bg-[#0A0A0A] p-6 rounded-2xl border border-white/5 space-y-4 relative overflow-hidden group hover:border-white/20 transition-colors">
                      ...
                      <p className="text-sm text-zinc-400 leading-relaxed">
                        Il buyer invia il pagamento che viene bloccato in escrow. A questo punto il venditore puÃƒÂ² procedere con la consegna.
                      </p>
                    </div>
                    ...
                    <div className="bg-[#0A0A0A] p-6 rounded-2xl border border-white/5 space-y-4 relative overflow-hidden group hover:border-white/20 transition-colors">
                      ...
                      <p className="text-sm text-zinc-400 leading-relaxed">
                        Una volta completata la consegna, lÃ¢â‚¬â„¢escrow verifica che i termini dellÃ¢â‚¬â„¢accordo siano stati rispettati.
                      </p>
                    </div>
                    ...
                    <div className="bg-[#0A0A0A] p-6 rounded-2xl border border-white/5 space-y-4 relative overflow-hidden group hover:border-white/20 transition-colors">
                      ...
                      <p className="text-sm text-zinc-400 leading-relaxed">
                        Se tutto ÃƒÂ¨ corretto, i fondi vengono rilasciati al venditore e la transazione viene completata.
                      </p>
                    </div>
                  </div>
                </section>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
                   <section className="space-y-4 h-full flex flex-col">
                    <h3 className="text-lg font-bold text-white flex items-center gap-2 font-inter">
                      <Scale className="text-white w-5 h-5" /> Chi gestisce lÃ¢â‚¬â„¢Escrow
                    </h3>
                    <div className="space-y-4 flex-1">
                      <div className="bg-[#0A0A0A] p-4 rounded-xl border border-white/5">
                        ...
                        <p className="text-xs text-zinc-400 leading-relaxed">
                          In molti casi lÃ¢â‚¬â„¢escrow viene gestito direttamente da OpenlyMarket. Questo garantisce un ambiente controllato e sicuro per le transazioni tra utenti.
                        </p>
                      </div>
                      <div className="bg-[#0A0A0A] p-4 rounded-xl border border-white/5">
                    ...
                    <div className="space-y-4 flex-1">
                      <div className="bg-[#0A0A0A] p-4 rounded-xl border border-white/5">
                        ...
                        <ul className="space-y-2 text-xs text-zinc-400">
                          <li>Ã¢â‚¬Â¢ Fondi bloccati fino alla consegna</li>
                          <li>Ã¢â‚¬Â¢ Riduzione rischio truffe</li>
                          <li>Ã¢â‚¬Â¢ Transazione sicura garantita</li>
                        </ul>
                      </div>
                      <div className="bg-[#0A0A0A] p-4 rounded-xl border border-white/5">
                        <h4 className="text-white font-bold text-sm mb-2 flex items-center gap-2">
                        ...
                        <ul className="space-y-2 text-xs text-zinc-400">
                          <li>Ã¢â‚¬Â¢ Fondi sicuri prima della consegna</li>
                          <li>Ã¢â‚¬Â¢ Evita mancati pagamenti</li>
                          <li>Ã¢â‚¬Â¢ Certezza della solvibilitÃƒÂ  del buyer</li>
                        </ul>
                      </div>
                    </div>
                  </section>
                    ...
                    <div className="bg-white/5 border border-white/10 rounded-xl p-4 flex gap-4 items-start">
                      ...
                      <div className="space-y-1">
                        ...
                        <p className="text-xs text-zinc-400 leading-relaxed">
                          ...
                          Qualsiasi tentativo di bypassare lÃ¢â‚¬â„¢escrow viola le regole della piattaforma.
                        </p>
                      </div>
                    </div>
                  </div>
