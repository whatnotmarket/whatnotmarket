...
const DISPOSABLE_BLOCKLIST_PATH = resolve(
  process.cwd(),
  "src/app/(ops)/maintenance/disposable_email_blocklist.conf"
);
const ALLOWLIST_PATH = resolve(process.cwd(), "src/app/(ops)/maintenance/allowlist.conf");
const EMAIL_PATTERN_BLOCKLIST_PATH = resolve(
  process.cwd(),
  "src/app/(ops)/maintenance/email_pattern_blocklist.conf"
);
