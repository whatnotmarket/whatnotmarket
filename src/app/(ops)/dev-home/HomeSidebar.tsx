...
export function HomeSidebar() {
  ...
  const commandSearchVars = {
    ...
    "--cmdk-trigger-bg": "#1E1E1E",
    "--cmdk-trigger-hover-bg": "#1E1E1E",
  ...
  return (
    <main className="relative z-[120] h-screen w-full overflow-hidden bg-[#111111]">
        ...
        <AnimatePresence initial={false}>
          {isMiniSidebarOpen ? (
            <motion.div
              ...
              className="pointer-events-none absolute bottom-3 left-3 right-3 top-3 overflow-hidden rounded-[22px] [corner-shape:squircle] border-t border-white/14 bg-[#1E1E1E] backdrop-blur-[10px] backdrop-saturate-[120%]"
            />
          ) : null}
        </AnimatePresence>
