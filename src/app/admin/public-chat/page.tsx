...
import { GLOBAL_CHAT_ROOMS } from "@/lib/chat/global-chat-config";
                  ...
                  <div className="flex items-start justify-between">
                    ...
                    <div className="shrink-0">
                      <div className="flex items-center gap-2">
                        ...
                        <Button onClick={() => act("ban_message", row.id)} className="rounded-2xl bg-red-600 text白 hover:bg-red-500 px-3">Ban</Button>
                        <div className="relative">
                          <Button
                            ...
                            className="rounded-2xl bg-zinc-800 text白 hover:bg-zinc-700 px-3"
                          >
                            User ▾
                          </Button>
                ...
                <div key={u.user_id} className="flex items-center justify-between rounded-xl border border-white/10 px-2 py-2">
                  <div>
                    ...
                    <div className="text-xs text-zinc-400">
                      {new Date(u.last_message_at).toLocaleString()} • {u.messages_count} messages
                    </div>
                  </div>
                  <div className="flex items-center gap-2">
