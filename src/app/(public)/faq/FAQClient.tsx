  ...
  const buyerFAQs: FAQItem[] = [
    {
        ...
        answer: copy['buyer_q1']?.answer || "OpenlyMarket ÃƒÂ¨ un marketplace 'Request-First'. Invece di sfogliare infinite liste di prodotti, pubblichi una richiesta specifica ('Cerco un account Netflix', 'Cerco uno script Python') e i venditori qualificati ti inviano offerte su misura."
    },
    {
        question: copy['buyer_q2']?.question || "I miei fondi sono al sicuro?",
        answer: copy['buyer_q2']?.answer || "Assolutamente sÃƒÂ¬. Utilizziamo un sistema di Escrow rigoroso. Quando paghi, i fondi vengono bloccati in un conto sicuro e vengono rilasciati al venditore solo dopo che hai confermato la ricezione del prodotto o servizio."
    },
    // Add more static fallbacks if needed, matching original file or seed
    {
        ...
        answer: "SÃƒÂ¬, grazie alla nostra funzione 'Smart Search'. Incolla il link del prodotto che desideri da qualsiasi e-commerce, paga in crypto, e noi lo acquisteremo e spediremo per te, proteggendo la tua privacy."
    },
    {
        question: "Quali criptovalute accettate?",
        answer: "Supportiamo le principali criptovalute per garantire flessibilitÃƒÂ  e privacy: Bitcoin (BTC), Ethereum (ETH), Litecoin (LTC), Monero (XMR) e Tether (USDT)."
    },
    {
        question: "Cosa succede se il venditore non consegna?",
        answer: "Se il venditore non consegna entro i termini stabiliti o il prodotto non ÃƒÂ¨ conforme, puoi aprire una disputa. I fondi in Escrow verranno congelati e, se verifichiamo l'inadempienza, ti verranno rimborsati al 100%."
    }
  ];
  ...
  const sellerFAQs: FAQItem[] = [
    {
        ...
        answer: copy['seller_q1']?.answer || "Per diventare venditore devi superare una procedura di verifica. ÃƒË† richiesta una fee d'ingresso una tantum di $20 e, per i livelli superiori, un deposito di sicurezza (Vendor Bond) per garantire la tua affidabilitÃƒÂ ."
    },
    // Add more static fallbacks
    {
        question: "Cos'ÃƒÂ¨ il Vendor Bond?",
        answer: "Il Vendor Bond ÃƒÂ¨ un deposito in criptovalute che rimane bloccato come garanzia. Serve a proteggere gli acquirenti da truffe o comportamenti scorretti. Se operi onestamente, i fondi rimangono tuoi."
    },
    {
    ...
    },
    {
        ...
        answer: "Puoi aumentare la tua visibilitÃƒÂ  acquistando pacchetti di sponsorizzazione (es. $25/mese). Le tue offerte appariranno in cima alle ricerche e nelle sezioni in evidenza, aumentando le probabilitÃƒÂ  di vendita."
    },
    {
