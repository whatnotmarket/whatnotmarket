          ...
          <div className="lg:sticky lg:top-32 self-start space-y-6">
            ...
            >
              ...
              <p className="text-zinc-400 text-base leading-relaxed">
                La tua privacy non ÃƒÂ¨ un'opzione, ÃƒÂ¨ la nostra prioritÃƒÂ . Scopri come proteggiamo i tuoi dati.
              </p>
            </motion.div>
          </div>
              ...
              <div className="p-8 md:p-10 space-y-12">
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-zinc-400 leading-relaxed">
                    OpenlyMarket ÃƒÂ¨ costruito sul principio della minimizzazione dei dati. Non raccogliamo informazioni che non sono strettamente necessarie per il funzionamento del servizio.
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="bg-[#0A0A0A] p-6 rounded-2xl border border-white/5 space-y-3">
                      ...
                      <p className="text-sm text-zinc-400 leading-relaxed">
                        Non richiediamo documenti d'identitÃƒÂ , passaporti o selfie. La tua identitÃƒÂ  reale rimane tua.
                      </p>
                    </div>
                ...
                <div className="bg-[#0A0A0A] p-6 rounded-2xl border border-white/5 mt-8">
                    <p className="text-xs text-zinc-500 text-center">
                        Ultimo aggiornamento: Marzo 2026. Questa policy puÃƒÂ² essere soggetta a modifiche.
                    </p>
                </div>
