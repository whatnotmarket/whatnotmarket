          ...
          <div className="lg:sticky lg:top-32 self-start space-y-6">
            ...
            >
              ...
              <p className="text-zinc-400 text-base leading-relaxed">
                Il marketplace digitale di nuova generazione. Sicuro, privato, efficiente.
              </p>
            </motion.div>
          </div>
              ...
              <div className="p-8 md:p-10 space-y-12">
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-zinc-400 leading-relaxed">
                    OpenlyMarket ÃƒÂ¨ una piattaforma globale dedicata allo scambio di beni e servizi digitali. 
                    Siamo nati con una missione chiara: creare un ambiente di trading sicuro dove la <strong>privacy</strong> ÃƒÂ¨ al primo posto e la <strong>fiducia</strong> ÃƒÂ¨ garantita dalla tecnologia, non dalla burocrazia.
                  </p>
                  <p className="text-zinc-400 leading-relaxed">
                ...
                <section className="space-y-6">
                  <h3 className="text-xl font-bold text-white font-inter">Cosa Facciamo</h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="bg-[#0A0A0A] p-6 rounded-2xl border border-white/5 space-y-3">
                      <Search className="w-8 h-8 text-white" />
                      <h4 className="text-white font-bold text-lg">Marketplace "Request-First"</h4>
                      <p className="text-sm text-zinc-400 leading-relaxed">
                        I buyer pubblicano richieste specifiche ("Cerco X"). I seller rispondono con offerte su misura. Questo elimina lo spam e garantisce deal mirati.
                      </p>
                    </div>
                    ...
                    <div className="bg-[#0A0A0A] p-6 rounded-2xl border border-white/5 space-y-3">
                      ...
                      <p className="text-sm text-zinc-400 leading-relaxed">
                        Ogni scambio ÃƒÂ¨ protetto. I fondi restano bloccati in un conto sicuro fino alla consegna confermata del servizio. Nessuna truffa, zero rischi.
                      </p>
                    </div>

                    <div className="bg-[#0A0A0A] p-6 rounded-2xl border border-white/5 space-y-3">
                      <Shield className="w-8 h-8 text-white" />
                      <h4 className="text-white font-bold text-lg">Venditori Verificati</h4>
                      <p className="text-sm text-zinc-400 leading-relaxed">
                        I nostri seller devono superare una verifica, versare una fee d'ingresso e bloccare un Bond (deposito) variabile in base al loro volume d'affari.
                      </p>
                    </div>
                    ...
                    <div className="bg-[#0A0A0A] p-6 rounded-2xl border border-white/5 space-y-3">
                      ...
                      <p className="text-sm text-zinc-400 leading-relaxed">
                        Supportiamo pagamenti veloci e anonimi tramite le principali criptovalute, garantendo libertÃƒÂ  finanziaria agli utenti di tutto il mondo.
                      </p>
                    </div>
                  </div>
                </section>
                ...
                <section className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    ...
                    <div className="bg-[#0A0A0A] p-4 rounded-xl border border-white/5 text-center">
                      ...
                      <p className="text-xs text-zinc-500 mt-1">Offrono qualitÃƒÂ  garantita</p>
                    </div>
                    <div className="bg-[#0A0A0A] p-4 rounded-xl border border-white/5 text-center">
                ...
                <section className="text-center space-y-8 pt-4">
                  <div className="max-w-2xl mx-auto space-y-4">
                    ...
                    <p className="text-zinc-400">
                      Che tu voglia vendere i tuoi servizi o trovare le migliori offerte digitali, OpenlyMarket ÃƒÂ¨ il posto giusto.
                    </p>
                  </div>
