              ...
              <div className="p-8 md:p-10 space-y-12">
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-zinc-400 leading-relaxed">
                    {whoWeAre.p1 || "OpenlyMarket ÃƒÂ¨ una piattaforma globale dedicata allo scambio di beni e servizi digitali. Siamo nati con una missione chiara: creare un ambiente di trading sicuro dove la privacy ÃƒÂ¨ al primo posto e la fiducia ÃƒÂ¨ garantita dalla tecnologia, non dalla burocrazia."}
                  </p>
                  <p className="text-zinc-400 leading-relaxed">
                ...
                <section className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="bg-[#0A0A0A] p-6 rounded-2xl border border-white/5 space-y-3">
                      ...
                      <p className="text-sm text-zinc-400 leading-relaxed">
                        {whatWeDo.card3_desc || "I venditori depositano una garanzia per dimostrare la loro serietÃƒÂ  e solvibilitÃƒÂ ."}
                      </p>
                    </div>
