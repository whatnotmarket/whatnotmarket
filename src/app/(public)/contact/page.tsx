                  ...
                  <div className="bg-[#0A0A0A] p-8 rounded-2xl border border-white/5 text-center space-y-6 relative overflow-hidden">
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-zinc-400 max-w-md mx-auto">
                            Il modo piÃƒÂ¹ veloce per ricevere assistenza. Il nostro team di supporto ÃƒÂ¨ attivo 24/7 per risolvere problemi relativi a ordini, account o escrow.
                        </p>
                    </div>
                ...
                <section className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="bg-[#0A0A0A] p-6 rounded-2xl border border-white/5 space-y-4">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-zinc-400 mb-4">Trova risposte immediate alle domande piÃƒÂ¹ frequenti.</p>
                            <Button 
                                variant="outline" 
