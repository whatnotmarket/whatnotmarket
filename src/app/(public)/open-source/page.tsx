              ...
              <div className="p-8 md:p-10 space-y-12">
                ...
                <section className="space-y-4">
                  <h2 className="text-2xl font-bold text-white flex items-center gap-3 font-inter">
                    <Github className="text-white w-6 h-6" /> PerchÃƒÂ© Open Source?
                  </h2>
                  <p className="text-zinc-400 leading-relaxed">
                    Crediamo che un marketplace che gestisce valore e dati sensibili debba essere completamente trasparente. 
                    Rendendo il nostro codice pubblico, permettiamo a chiunque di verificare come vengono gestiti i dati, come funzionano gli smart contract (ove presenti) e come ÃƒÂ¨ costruita la sicurezza della piattaforma.
                  </p>
                  <p className="text-zinc-400 leading-relaxed">
                    La sicurezza attraverso l'oscuritÃƒÂ  ÃƒÂ¨ un mito. La vera sicurezza nasce dalla verifica costante di migliaia di occhi esperti.
                  </p>
                </section>
                ...
                <section className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="bg-[#0A0A0A] p-6 rounded-2xl border border-white/5 space-y-3">
                      ...
                      <p className="text-sm text-zinc-400 leading-relaxed">
                        Interamente scritto in <strong>TypeScript</strong>. La tipizzazione statica riduce i bug e migliora la qualitÃƒÂ  del codice, rendendo i refactoring piÃƒÂ¹ sicuri.
                      </p>
                    </div>
                  ...
                  <div className="bg-[#0A0A0A] p-8 rounded-2xl border border-white/5 relative overflow-hidden">
                    ...
                    <div className="relative z-10 space-y-4">
                        <p className="text-zinc-400 max-w-2xl">
                            Accogliamo contributi da sviluppatori di tutto il mondo. Che si tratti di fixare un bug, migliorare la documentazione o proporre nuove feature, ogni aiuto ÃƒÂ¨ prezioso.
                        </p>
