...
const pricingRows = [
  ["€0 – €5,000", "2.20% (€40 minimum)", "4.40% (€80 minimum)", "€5,000 → €110", "EU Card 1.4% + €0.25 / Int Card 2.9% + €0.25 / PayPal 3.49% + €0.35 / Crypto 0.30% / SEPA €1"],
  ["€5,000.01 – €50,000", "2.05% (€100 minimum)", "4.10%", "€20,000 → €410", "Same payment fees"],
  ["€50,000.01 – €200,000", "1.65% (€950 minimum)", "3.30%", "€100,000 → €1,650", "Same payment fees"],
  ["€200,000.01 – €500,000", "1.30% (€3,200 minimum)", "2.60%", "€300,000 → €3,900", "Same payment fees"],
  ["€500,000.01 – €1,000,000", "1.05% (€6,500 minimum)", "2.10%", "€750,000 → €7,875", "Same payment fees"],
  ["€1,000,000.01 – €3,000,000", "0.90% (€10,500 minimum)", "1.80%", "€2M → €18,000", "Same payment fees"],
  ["€3,000,000.01 – €5,000,000", "0.85% (€25,000 minimum)", "1.70%", "€4M → €34,000", "Same payment fees"],
  ["€5,000,000.01 – €10,000,000", "0.80% (€40,000 minimum)", "1.60%", "€8M → €64,000", "Same payment fees"],
  ["€10,000,000.01+", "0.60% (Custom quote)", "1.20%", "€20M → €120,000", "Same payment fees"],
] as const;

const competitorRows = [
  ["€0 – €5,000", "2.20%", "2.60%", "2.54%", "↓ 15% lower"],
  ["€5,000 – €50,000", "2.05%", "2.40%", "2.35%", "↓ 14% lower"],
  ["€50,000 – €200,000", "1.65%", "1.90%", "1.85%", "↓ 13% lower"],
  ["€200,000 – €500,000", "1.30%", "1.50%", "1.47%", "↓ 12% lower"],
  ["€500,000 – €1,000,000", "1.05%", "1.20%", "1.17%", "↓ 12% lower"],
  ["€1,000,000 – €3,000,000", "0.90%", "1.00%", "0.98%", "↓ 10% lower"],
  ["€3,000,000 – €5,000,000", "0.85%", "0.95%", "0.93%", "↓ 10% lower"],
  ["€5,000,000 – €10,000,000", "0.80%", "0.90%", "0.88%", "↓ 10% lower"],
  ["€10,000,000+", "0.60%", "0.70%", "0.68%", "↓ 12% lower"],
] as const;
...
const currencyMethodMap = {
  ...
  BRL: {
    ...
    bank: ["TED", "DOC", "PIX"],
    local: ["PIX", "Boleto Bancário", "Mercado Pago", "PicPay"],
    crypto: ["BTC", "ETH", "LTC", "USDT", "USDC", "DAI"],
  },
} as const;
      ...
      <main className="mx-auto flex w-full max-w-[1380px] flex-col gap-8 px-4 py-8 md:px-6 lg:py-10">
        <section className="relative overflow-hidden rounded-[30px] border border-white/10 bg-gradient-to-br from-[#161a24] via-[#12131a] to-[#0e0f14] p-6 shadow-[0_24px_80px_rgba(0,0,0,0.45)] md:p-10">
          ...
          <div className="relative z-10 max-w-4xl space-y-4">
            <Badge className="bg-white/10 text-white">Transparent pricing · No hidden fees</Badge>
            ...
            <Card className="bg-[#0d0f12] ring-white/10">
              ...
              <CardContent className="space-y-3 text-sm">
                <div className="rounded-lg border border-white/10 bg-zinc-900 p-3 text-zinc-300">
                  ...
                  <p className="mt-1">Self-service setup · Automated processing · Ideal for straightforward deals · Lower fee</p>
                </div>
                <div className="rounded-lg border border-blue-500/35 bg-blue-500/10 p-3 text-zinc-100">
                  ...
                  <p className="mt-1">Dedicated assistance · Manual verification · Ideal for complex/high-value deals · Premium fee</p>
                </div>
              </CardContent>
            </Card>
          </div>
