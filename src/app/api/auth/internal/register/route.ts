...
import { signInBridgeUserOnRoute } from "@/lib/auth/bridge";
import { getRedirectPath } from "@/lib/redirects";
import { createAdminClient } from "@/lib/supabase-admin";
import { generateInternalAuthEmail } from "@/lib/internal-auth/identity";
import {
  onboardingRegistrationSchema,
  type OnboardingRegistrationInput,
} from "@/lib/internal-auth/schemas";
import { hashInternalPassword, encryptRecoveryPhrase } from "@/lib/internal-auth/security";
import {
  createInternalIdentitySession,
  setInternalSessionCookie,
} from "@/lib/internal-auth/sessions";
