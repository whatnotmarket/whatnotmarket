              ...
              <div className="p-8 md:p-10 space-y-12">
                ...
                <section className="space-y-6 text-center md:text-left">
                  ...
                  <p className="text-zinc-400 leading-relaxed max-w-2xl">
                    {intro.text || "Smart Search è il nostro servizio di Proxy Buying avanzato. Ti permette di acquistare prodotti da Amazon, eBay, o qualsiasi altro e-commerce globale pagando in criptovalute. Noi gestiamo l'acquisto e la logistica, proteggendo la tua identità dal venditore originale."}
                  </p>
                </section>
