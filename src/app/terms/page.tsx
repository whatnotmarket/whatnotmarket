                ...
                >
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-zinc-400 text-base leading-relaxed">
                            Please read these terms carefully before using our platform. They govern your relationship with OpenlyMarket.
                        </p>
            ...
            >
                ...
                >
                    <div className="space-y-4">
                        ...
                        <p>
                            Welcome to OpenlyMarket ("we," "our," or "us"). By accessing or using our website, services, or applications (collectively, the "Services"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, do not use our Services.
                        </p>
                    </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <p>
                            OpenlyMarket acts as a venue to allow users who comply with our policies to offer, sell, and buy certain goods and services. We are not a party to the actual transaction between buyers and sellers.
                        </p>
                    ...
                    <div className="space-y-4">
                        ...
                        <p>
                            To the fullest extent permitted by law, OpenlyMarket shall not be liable for any indirect, incidental, special, consequential, or punitive damages, or any loss of profits or revenues, whether incurred directly or indirectly.
                        </p>
                    </div>
                    ...
                    <div className="space-y-4 border-t border-white/5 pt-8">
                        ...
                        <p>
                            If you have any questions about these Terms, please contact us at <span className="text-white hover:underline cursor-pointer">support@openlymarket.com</span>.
                        </p>
                    </div>
                </Card>
            </motion.div>
