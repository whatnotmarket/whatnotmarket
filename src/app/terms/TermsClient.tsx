                ...
                >
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-zinc-400 text-base leading-relaxed">
                            {header.subtitle || "Please read these terms carefully before using our platform. They govern your relationship with Whatnot Market."}
                        </p>
            ...
            >
                ...
                >
                    <div className="space-y-4">
                        ...
                        <p>
                            {content.section1_text || 'Welcome to Whatnot Market ("we," "our," or "us"). By accessing or using our website, services, or applications (collectively, the "Services"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, do not use our Services.'}
                        </p>
                    </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <p>
                            {content.section3_text || "Whatnot Market acts as a venue to allow users who comply with our policies to offer, sell, and buy certain goods and services. We are not a party to the actual transaction between buyers and sellers."}
                        </p>
