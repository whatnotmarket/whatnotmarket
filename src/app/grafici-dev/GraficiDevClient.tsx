...
import LightweightDocsShowcase from "@/components/charts/lightweight-docs-showcase";
import KLineChartsDevCard from "@/components/charts/klinecharts-dev-card";
  ...
  useEffect(() => {
    ...
    const handleCrosshairMove = (param: MouseEventParams<Time>) => {
      ...
      setAdvancedRulerText(
        `Ruler Δ ${delta.toFixed(2)} (${percent.toFixed(2)}%) | Close ${pointData.close.toFixed(2)}`
      );
    };
