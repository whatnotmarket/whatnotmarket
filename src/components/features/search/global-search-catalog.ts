...
export const SEARCH_CATALOG: SearchCatalogItem[] = [
  ...
  },
  {
    ...
    description: "Sneakers â€¢ black â€¢ used",
  ...
  },
  {
    ...
    description: "Running shoes â€¢ white â€¢ new",
  ...
  },
  {
    id: "brand-nike",
    title: "Nike",
    description: "Top brand â€¢ 124 products",
  ...
  },
  {
    id: "brand-apple",
    title: "Apple",
    description: "Premium brand â€¢ 83 products",
  ...
  },
  {
    ...
    description: "Collection â€¢ curated picks",
  ...
  },
  {
    ...
    title: "Under 100",
    description: "Collection â€¢ budget deals",
...
export function createQuerySuggestions(rawQuery: string): SearchCatalogItem[] {
  ...
  if (parsed.intent === "buy" || parsed.entities.brand || parsed.entities.category || parsed.entities.maxPrice !== undefined) {
    const priceHint =
      parsed.entities.maxPrice !== undefined ? `under â‚¬${Math.round(parsed.entities.maxPrice)}` : "with smart filters";
    suggestions.push({
