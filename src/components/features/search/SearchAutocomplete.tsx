...
const MOCK_DATA: GroupedResults = {
  countries: [
    { id: 'is', name: 'Iceland', desc: 'from $1.72 / day', icon: 'ðŸ‡®ðŸ‡¸', href: '/market?country=is' },
    { id: 'in', name: 'India', desc: 'from $2.16 / day', icon: 'ðŸ‡®ðŸ‡³', href: '/market?country=in' },
    { id: 'id', name: 'Indonesia', desc: 'from $1.88 / day', icon: 'ðŸ‡®ðŸ‡©', href: '/market?country=id' },
    { id: 'it', name: 'Italy', desc: 'from $2.50 / day', icon: 'ðŸ‡®ðŸ‡¹', href: '/market?country=it' },
    { id: 'us', name: 'United States', desc: 'from $3.00 / day', icon: 'ðŸ‡ºðŸ‡¸', href: '/market?country=us' },
  ],
  regions: [
