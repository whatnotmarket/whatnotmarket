...
> = {
  ...
  es: { label: "Spanish", nativeLabel: "EspaÃ±ol", Flag: Flags.ES },
  pl: { label: "Polish", nativeLabel: "Polski", Flag: Flags.PL },
  ru: { label: "Russian", nativeLabel: "Ð ÑƒÑÑÐºÐ¸Ð¹", Flag: Flags.RU },
  uk: { label: "Ukrainian", nativeLabel: "Ð£ÐºÑ€Ð°Ñ—Ð½ÑÑŒÐºÐ°", Flag: Flags.UA },
  tr: { label: "Turkish", nativeLabel: "TÃ¼rkÃ§e", Flag: Flags.TR },
  ro: { label: "Romanian", nativeLabel: "RomÃ¢nÄƒ", Flag: Flags.RO },
  "pt-br": { label: "Portuguese (Brazil)", nativeLabel: "PortuguÃªs (Brasil)", Flag: Flags.BR },
};
