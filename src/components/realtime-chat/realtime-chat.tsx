...
import { TradePanel } from '@/components/chat/trade-panel'
            ...
            <div className="p-4 overflow-y-auto">
              {sideMode === 'profile' && targetUser && (
                <div className="space-y-5">
                  ...
                  {panelLoading && <div className="text-xs text-zinc-400">Aggiornamento dati…</div>}
                </div>
              )}
              {sideMode === 'info' && (
          ...
          <FieldGroup>
            ...
            <Field>
              ...
              <Textarea
                ...
                placeholder="Descrivi dettagliatamente cosa è successo (min. 20 caratteri)..."
      ...
      <Dialog open={isBlockModalOpen} onOpenChange={setIsBlockModalOpen}>
        <DialogContent className="sm:max-w-sm">
          <DialogHeader>
            ...
            <DialogDescription>
              Sei sicuro di voler bloccare {targetUser?.name || 'questo utente'}? Non potrete più scambiarvi messaggi.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
            <DialogClose asChild>
