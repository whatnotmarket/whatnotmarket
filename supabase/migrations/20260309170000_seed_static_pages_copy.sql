...
VALUES
  ...
  ('/about', 'who_we_are', 'p1', 'Paragraph 1', 'OpenlyMarket Ã¨ una piattaforma globale dedicata allo scambio di beni e servizi digitali. Siamo nati con una missione chiara: creare un ambiente di trading sicuro dove la privacy Ã¨ al primo posto e la fiducia Ã¨ garantita dalla tecnologia, non dalla burocrazia.', 'textarea', 'it'),
  ...
  ('/about', 'what_we_do', 'card3_desc', 'Card 3 Desc', 'I venditori depositano una garanzia per dimostrare la loro serietÃ  e solvibilitÃ .', 'textarea', 'it'),
  ...
  ('/terms', 'header', 'subtitle', 'Page Subtitle', 'Please read these terms carefully before using our platform. They govern your relationship with OpenlyMarket.', 'textarea', 'en'),
  ...
  ('/terms', 'content', 'section1_text', 'Section 1 Text', 'Welcome to OpenlyMarket ("we," "our," or "us"). By accessing or using our website, services, or applications (collectively, the "Services"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, do not use our Services.', 'textarea', 'en'),
  ...
  ('/terms', 'content', 'section3_text', 'Section 3 Text', 'OpenlyMarket acts as a venue to allow users who comply with our policies to offer, sell, and buy certain goods and services. We are not a party to the actual transaction between buyers and sellers.', 'textarea', 'en'),
  ...
  ('/privacy', 'header', 'subtitle', 'Page Subtitle', 'La tua privacy non Ã¨ un''opzione, Ã¨ la nostra prioritÃ . Scopri come proteggiamo i tuoi dati.', 'textarea', 'it'),
  ...
  ('/privacy', 'philosophy', 'text', 'Section Text', 'OpenlyMarket Ã¨ costruito sul principio della minimizzazione dei dati. Non raccogliamo informazioni che non sono strettamente necessarie per il funzionamento del servizio. Crediamo che l''anonimato sia un diritto fondamentale, specialmente nel mondo delle transazioni digitali.', 'textarea', 'it'),
  ('/privacy', 'data', 'title', 'Section Title', 'Dati che Raccogliamo', 'title', 'it'),
  ('/privacy', 'data', 'card1_title', 'Card 1 Title', 'Nessun KYC', 'plain', 'it'),
  ('/privacy', 'data', 'card1_desc', 'Card 1 Desc', 'Non richiediamo documenti d''identitÃ , passaporti o selfie. La tua identitÃ  reale rimane tua.', 'textarea', 'it'),
  ...
  ('/faq', 'header', 'subtitle', 'Page Subtitle', 'Tutto quello che devi sapere per usare OpenlyMarket al meglio.', 'textarea', 'it'),
  ...
  -- Buyer FAQs
  ('/faq', 'buyer_q1', 'question', 'Question', 'Come funziona OpenlyMarket?', 'plain', 'it'),
  ('/faq', 'buyer_q1', 'answer', 'Answer', 'OpenlyMarket Ã¨ un marketplace ''Request-First''. Invece di sfogliare infinite liste di prodotti, pubblichi una richiesta specifica (''Cerco un account Netflix'', ''Cerco uno script Python'') e i venditori qualificati ti inviano offerte su misura.', 'textarea', 'it'),
  ('/faq', 'buyer_q2', 'question', 'Question', 'I miei fondi sono al sicuro?', 'plain', 'it'),
  ('/faq', 'buyer_q2', 'answer', 'Answer', 'Assolutamente sÃ¬. Utilizziamo un sistema di Escrow rigoroso. Quando paghi, i fondi vengono bloccati in un conto sicuro e vengono rilasciati al venditore solo dopo che hai confermato la ricezione del prodotto o servizio.', 'textarea', 'it'),
  -- Seller FAQs
  ('/faq', 'seller_q1', 'question', 'Question', 'Come divento un venditore?', 'plain', 'it'),
  ('/faq', 'seller_q1', 'answer', 'Answer', 'Per diventare venditore devi superare una procedura di verifica. Ãˆ richiesta una fee d''ingresso una tantum di $20 e, per i livelli superiori, un deposito di sicurezza (Vendor Bond) per garantire la tua affidabilitÃ .', 'textarea', 'it'),
  ...
  ('/contact', 'telegram', 'desc', 'Description', 'Il canale piÃ¹ veloce. Risposta media in 5 minuti.', 'plain', 'it'),
