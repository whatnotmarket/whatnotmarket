...
VALUES
  ...
  ('/about', 'who_we_are', 'p1', 'Paragraph 1', 'Whatnot Market è una piattaforma globale dedicata allo scambio di beni e servizi digitali. Siamo nati con una missione chiara: creare un ambiente di trading sicuro dove la privacy è al primo posto e la fiducia è garantita dalla tecnologia, non dalla burocrazia.', 'textarea', 'it'),
  ...
  ('/terms', 'header', 'subtitle', 'Page Subtitle', 'Please read these terms carefully before using our platform. They govern your relationship with Whatnot Market.', 'textarea', 'en'),
  ...
  ('/terms', 'content', 'section1_text', 'Section 1 Text', 'Welcome to Whatnot Market ("we," "our," or "us"). By accessing or using our website, services, or applications (collectively, the "Services"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, do not use our Services.', 'textarea', 'en'),
  ...
  ('/terms', 'content', 'section3_text', 'Section 3 Text', 'Whatnot Market acts as a venue to allow users who comply with our policies to offer, sell, and buy certain goods and services. We are not a party to the actual transaction between buyers and sellers.', 'textarea', 'en'),
  ...
  ('/privacy', 'philosophy', 'text', 'Section Text', 'Whatnot Market è costruito sul principio della minimizzazione dei dati. Non raccogliamo informazioni che non sono strettamente necessarie per il funzionamento del servizio. Crediamo che l''anonimato sia un diritto fondamentale, specialmente nel mondo delle transazioni digitali.', 'textarea', 'it'),
  ...
  ('/faq', 'header', 'subtitle', 'Page Subtitle', 'Tutto quello che devi sapere per usare Whatnot Market al meglio.', 'textarea', 'it'),
  ...
  -- Buyer FAQs
  ('/faq', 'buyer_q1', 'question', 'Question', 'Come funziona Whatnot Market?', 'plain', 'it'),
  ('/faq', 'buyer_q1', 'answer', 'Answer', 'Whatnot Market è un marketplace ''Request-First''. Invece di sfogliare infinite liste di prodotti, pubblichi una richiesta specifica (''Cerco un account Netflix'', ''Cerco uno script Python'') e i venditori qualificati ti inviano offerte su misura.', 'textarea', 'it'),
