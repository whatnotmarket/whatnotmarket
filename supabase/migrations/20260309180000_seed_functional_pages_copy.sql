...
VALUES
  ...
  ('/become-seller', 'steps', 'step2_subtitle', 'Step 2 Subtitle', 'Parlaci della tua attivitÃ ', 'plain', 'it'),
  ...
  ('/become-seller', 'requirements', 'fee_desc', 'Fee Desc', 'Una tantum per filtrare lo spam e garantire serietÃ .', 'textarea', 'it'),
  ...
  ('/become-seller', 'form', 'escrow_label', 'Escrow Label', 'Hai giÃ  usato Escrow?', 'plain', 'it'),
  ...
  ('/smart-search', 'intro', 'text', 'Intro Text', 'Smart Search Ã¨ il nostro servizio di Proxy Buying avanzato. Ti permette di acquistare prodotti da Amazon, eBay, o qualsiasi altro e-commerce globale pagando in criptovalute. Noi gestiamo l''acquisto e la logistica, proteggendo la tua identitÃ  dal venditore originale.', 'textarea', 'it'),
  ...
  ('/buy-with-crypto', 'confirmed', 'subtitle', 'Confirmed Subtitle', 'Il tuo ordine proxy Ã¨ stato avviato. Segui lo stato con il tracking ID.', 'textarea', 'it'),
